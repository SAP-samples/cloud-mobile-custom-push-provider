...
/**
 * Accept the appId and appSecret given by the user and build the credential Every app has a credential which is for
 * certification
 */
public class HuaweiCredential {
	private static final Logger logger = LoggerFactory.getLogger(HuaweiCredential.class);

	private final String PUSH_AT_URL = ResourceBundle.getBundle("config").getString("huawei_token_server");
