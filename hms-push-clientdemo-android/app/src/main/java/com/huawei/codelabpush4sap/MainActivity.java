...
package com.huawei.codelabpush4sap;
...
import com.huawei.codelabpush4sap.R;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private final String regUrlToSAP = serverUrl + "/mobileservices/push/v1/runtime/applications/" + appID + "/os/custom/devices/huaweidevicetest";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_register_cf).setOnClickListener(this);
        findViewById(R.id.btn_register_device).setOnClickListener(this);
    ...
    private void registerToSAPWithOauth(){
        showLog("register cf: register to sap with Oauth");
        try {
        ...
        okHttpClient.newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(@NotNull Call call, @NotNull IOException e) {
                ...
                Log.e(TAG, "register cf:" + e.getMessage());
                showLog("register cf:" + e.getMessage());
            }
...
//                showLog("response code " + response.code());
                if(response.isSuccessful()){
                    Log.i(TAG, "register cf: ok");
                    showLog("register cf: ok");
                }
            }
        });
    }

    private void registerToCustomPush(){
        ...
        Log.e("huawei push token is ", pushToken);
        ...
        ClientProvider.get().newCall(req).enqueue(new Callback() {
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                if(response.isSuccessful()){
                    ...
                    showLog("register device to Custom Push success " + response.message());
                }
            }
        });
    }
